# TAKE_CANADA_BACK Documentation

Complete documentation for **TAKE_CANADA_BACK**, an open-source, tamper-evident
...
| If you want to… | Read |
| --- | --- |
| Understand what TAKE_CANADA_BACK is and how the pieces fit | [ARCHITECTURE.md](./ARCHITECTURE.md) |
...
4. TAKE_CANADA_BACK records **provenance** (where it came from, when, who collected it).
...
These live alongside the engine because they are meant to be used *with* TAKE_CANADA_BACK:
